...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengEntity user = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xuejihao", username));
    ...
    public R register(@RequestBody XueshengEntity xuesheng){
    	...
    	XueshengEntity user = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xuejihao", xuesheng.getXuejihao()));
		if(user!=null) {
