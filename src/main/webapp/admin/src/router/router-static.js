...
import center from '@/views/center'
    ...
    import peiyangjihua from '@/views/modules/peiyangjihua/list'
    import xuesheng from '@/views/modules/xuesheng/list'
    import yuanxibanji from '@/views/modules/yuanxibanji/list'
    import xueshengjiangcheng from '@/views/modules/xueshengjiangcheng/list'
...
const routes = [{
	...
	path: '/yuanxibanji',
        name: '院系班级',
        component: yuanxibanji
      }
      ,{
	path: '/xueshengjiangcheng',
        name: '学生奖惩',
        component: xueshengjiangcheng
      }
      ,{
	path: '/jiaoshi',
        name: '教师',
