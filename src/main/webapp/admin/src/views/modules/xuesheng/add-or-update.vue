<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学制" prop="xuezhi">
          <el-input v-model="ruleForm.xuezhi" 
              placeholder="学制" clearable  :readonly="ro.xuezhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学制" prop="xuezhi">
              <el-input v-model="ruleForm.xuezhi" 
