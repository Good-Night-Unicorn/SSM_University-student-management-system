<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学籍号" prop="xuejihao">
          <el-input v-model="ruleForm.xuejihao" 
              placeholder="学籍号" clearable  :readonly="ro.xuejihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学籍号" prop="xuejihao">
              <el-input v-model="ruleForm.xuejihao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="理由" prop="liyou">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.liyou" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.liyou" label="理由" prop="liyou">
                    <span v-html="ruleForm.liyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.xuejihao!=''&&json.xuejihao){
	...
	this.ruleForm.liyou = this.ruleForm.liyou.replace(reg,'../../../ssmm4dtg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
