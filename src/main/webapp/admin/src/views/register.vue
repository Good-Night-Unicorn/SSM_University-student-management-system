  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">高校学生管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xuejihao" class="input" type="text" placeholder="学籍号">
			   </div>
			 </div> -->
			<el-form-item label="学籍号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuejihao" autocomplete="off" placeholder="学籍号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="民族" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.minzu" autocomplete="off" placeholder="民族"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xuezhi" class="input" type="text" placeholder="学制">
			   </div>
			 </div> -->
			<el-form-item label="学制" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuezhi" autocomplete="off" placeholder="学制"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">政治面貌</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhengzhimianmao" class="input" type="text" placeholder="政治面貌">
			   </div>
			 </div> -->
			<el-form-item label="政治面貌" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.zhengzhimianmao" autocomplete="off" placeholder="政治面貌"  />
			</el-form-item>
